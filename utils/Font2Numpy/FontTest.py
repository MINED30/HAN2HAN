...
def test_font(font_path,font_n):
    '''
...
def test_fonts_in_path(font_path="Path containining fonts"):
    ...
    for i in range(0,len(fonts)):
        testing = test_font(font_path, fonts[i])
        if testing :
            error_list.append(i)
            print("[ERROR]", i, '\t', testing)
        else :
            print("[PASS_]", i, '\t', fonts[i])

    for i in range(len(error_list)):
        fonts.pop(error_list[i]-i)  # pop font which has error
